...
#### The Software
In order to collect and filter the data, the program realtime_two_channel_plot.py from Bernd Porr's [pyusbdux](https://github.com/berndporr/pyusbdux) was hacked to plot both the filtered and unfiltered data. 
...
### Appendix 1:
[Video](https://www.youtube.com/watch?v=l5tNWcIArMU&feature=youtu.be) of the program processing in real time.
